...
const LICENSE_TIERS = {
  ...
  PROFESSIONAL: {
    ...
    description: 'For small teams and collaborative development',
    ...
    pricing: {
      ...
      currency: 'USD',
      billingCycle: 'monthly',
      perSeatMonthly: 30, // Additional seats beyond included
      includedSeats: 3
    },
  ...
  MAX: {
    ...
    pricing: {
      ...
      currency: 'USD',
      billingCycle: 'monthly',
      perSeatMonthly: 25, // Additional seats beyond included
      includedSeats: 10
    },
  ...
  ENTERPRISE: {
    ...
    pricing: {
      monthly: 999, // Base monthly fee
      annual: 9990, // ~$832.50/month (2 months free)
      currency: 'USD',
      billingCycle: 'monthly',
      perSeatMonthly: 20, // Per seat after first 10
      includedSeats: 10,
      contactSales: false // Still available for custom enterprise deals
    },
    ...
    limits: {
      ...
      teamMembers: -1, // Unlimited (pay per seat)
