...
class SecurityManager {
  ...
  async configureSSHHardeningWithState(instanceId, publicIp, options = {}, connectionParams) {
    ...
    try {
      ...
      await this.testNewSSHConnection(publicIp, username, customPort, connectOptions.privateKeyPath);
...
`;
   ...
   */
  async testNewSSHConnection(publicIp, username, customPort, privateKeyPath) {
    const ssh = new SSHService();
