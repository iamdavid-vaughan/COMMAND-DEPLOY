...
class EnhancedSSLService {
  ...
  async configureMultiDomainNginxSSL(host, domainConfigs, appPort, certificatePath, privateKeyPath, sshOptions = {}, dryRun = false) {
    ...
    try {
      // Generate DH parameters for better security (optional - nginx works without it)
      logger.info(chalk.blue('🔐 Generating Diffie-Hellman parameters (this may take 1-2 minutes)...'));
