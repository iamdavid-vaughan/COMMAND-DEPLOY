...
class SSHService {
  ...
  async connect(host, options = {}) {
    ...
    return new Promise((resolve, reject) => {
      ...
      // Remove privateKeyPath from options to prevent undefined override during spread
      const { privateKeyPath: _, ...optionsWithoutPrivateKeyPath } = options;
      ...
      const connectionOptions = {
        ...
        ...optionsWithoutPrivateKeyPath,
        // Only set privateKeyPath if it has a truthy value
